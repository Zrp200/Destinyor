...
public class UI {
	...
	//public static boolean MinimapOn = false;
        //public static boolean InventoryOn = false;
	...
	private static int BorderWidth = 16, BorderHeight = 12;
	private static int GroundWidth = 16, GroundHeight = 12;
	
	//private static int BorderWidth = 1920 / 64, BorderHeight = 1080 / 64;
	//private static int GroundWidth = 1920 / 64, GroundHeight = 1080 / 64;
        

	
	//private static int EnemyTextWidth = 1920, EnemyTextHeight = 16;
	...
	private static void BorderX(Screen screen, int w, int h){
		for(int i = 0; i < w; i++) {
			for(int j = 0; j < h; j++) {
				...
				//screen.render(Art.spritesheet[16][3], (i + 0) * Tile.SIZE, 8 * Tile.SIZE);
