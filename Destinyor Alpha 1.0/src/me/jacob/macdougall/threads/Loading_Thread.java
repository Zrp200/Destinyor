...
public class Loading_Thread extends Thread_Controller implements Runnable { 
    ...
    private void reader() {
        ...
        switch(reader) {
            ...
            case 1: FileLoader.ReadFromFiles(Destinyor.DestinyorEnemies);
            reader++;
            break;
            
            case 2: FileLoader.ReadFromFiles(Destinyor.DestinyorNpcs);
            reader++;
            break;
                
            case 3: FileLoader.ReadFromFiles(Destinyor.DestinyorSaves);
            reader++;
            break;
