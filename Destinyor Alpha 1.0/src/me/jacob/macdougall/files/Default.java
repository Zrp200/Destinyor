...
public class Default {
	...
	private static Map<Integer, String[]> enemyStat = new HashMap<>();
	private static Map<Integer, String[]> spells = new HashMap<>();
	private static Map<Integer, String[]> npcs = new HashMap<>();
        private static Map<String, String[]> npcDialouge = new HashMap<>();
