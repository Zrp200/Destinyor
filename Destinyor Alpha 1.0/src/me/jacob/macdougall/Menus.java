...
//		}
	...
	public void render(Screen screen) {
		switch(menu) {
			case -1: break;
			case 0: for(int i = 0; i < buttons.get(menu).length; i++) {
						buttons.get(menu)[i].render(screen);
					}
					break;
			case 1: for(int i = 0; i < buttons.get(menu).length; i++) {
						buttons.get(menu)[i].render(screen);
					}
					break;
			case 2: for(int i = 0; i < buttons.get(menu).length; i++) {
						buttons.get(menu)[i].render(screen);
					}
			rButton.render(screen);
					break;
			case 3: for(int i = 0; i < buttons.get(menu).length; i++) {
				buttons.get(menu)[i].render(screen);
			}
			break;
		}
