...
public class Cutscene {
    ...
    private static Map<Integer, Integer> directions = new HashMap<>();
...
//    private int[] ddirsf;
    ...
    public Cutscene(String location, InputHandler input) {
        ...
        for(int i = 0; i < info.length; i++) {
            if(info[i].contains("X")) {
                x = Integer.parseInt(String.valueOf(info[i].charAt(2)));
            }
            if(info[i].contains("Y")) {
                y = Integer.parseInt(String.valueOf(info[i].charAt(2)));
            }
            if(info[i].contains("Level")) {
                level = Integer.parseInt(String.valueOf(info[i].charAt(6)));
            }
        }
...
//            System.out.println("");
            ...
            for(int d1 = 0; d1 < direction.length; d1++) {
            	for(int d2 = 0; d2 < direction[d1].length; d2++) {
